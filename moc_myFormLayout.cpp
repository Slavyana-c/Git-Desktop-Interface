...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyLayout_t, stringdata) + ofs \
...
const QMetaObject MyLayout::staticMetaObject = {
    { &QFormLayout::staticMetaObject, qt_meta_stringdata_MyLayout.data,
      qt_meta_data_MyLayout,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyLayout.stringdata))
