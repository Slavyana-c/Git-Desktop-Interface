...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) .tmp/2811_gui1.0.0/ && $(COPY_FILE) --parents window.h tabs.h .tmp/2811_gui1.0.0/ && $(COPY_FILE) --parents globals.cc main.cc window.cc tabs.cc el17oa.cc sc17sdc.cc sc17xc.cc el17dtt.cc el17flc.cc scsfsa.cc .tmp/2811_gui1.0.0/ && (cd `dirname .tmp/2811_gui1.0.0` && $(TAR) 2811_gui1.0.0.tar 2811_gui1.0.0 && $(COMPRESS) 2811_gui1.0.0.tar) && $(MOVE) `dirname .tmp/2811_gui1.0.0`/2811_gui1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/2811_gui1.0.0
